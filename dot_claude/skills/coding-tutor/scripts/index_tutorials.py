...
Usage:
    uv run python .claude/skills/coding-tutor/scripts/index_tutorials.py
    uv run python .claude/skills/coding-tutor/scripts/index_tutorials.py --tutorials-dir /path/to/tutorials
    uv run python .claude/skills/coding-tutor/scripts/index_tutorials.py --format json
    uv run python .claude/skills/coding-tutor/scripts/index_tutorials.py --format human
"""
...
def extract_frontmatter(filepath: Path) -> dict[str, Any] | None:
    ...
    Note:
        This is a simple line-based parser. Multiline values or colons inside
        values may not be parsed correctly. Keep frontmatter fields simple.
    """
...
def index_tutorials(tutorials_dir: str | None = None) -> list[dict[str, Any]]:
    """
...
def format_human_readable(tutorials: list[dict[str, Any]]) -> str:
