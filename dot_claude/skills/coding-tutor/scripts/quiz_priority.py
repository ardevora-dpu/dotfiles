#!/usr/bin/env python3
"""
Prioritise tutorials for quizzing based on spaced repetition.

Usage:
    uv run python .claude/skills/coding-tutor/scripts/quiz_priority.py
    uv run python .claude/skills/coding-tutor/scripts/quiz_priority.py --tutorials-dir /path/to/tutorials
...
def calculate_priority(tutorial: dict[str, Any], today: date) -> float:
    """
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Prioritise tutorials for quizzing based on spaced repetition"
    )
    parser.add_argument(
        "--tutorials-dir",
