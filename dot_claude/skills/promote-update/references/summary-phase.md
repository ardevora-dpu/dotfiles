...
- Wrong files staged on promotion branch: delete/reset `timon/pre-update-promotion` and rerun Stage PR from a fresh temporary worktree, then restart from Simulate + Classify.
